...
function fAddSampleData(dbConn) {
  const mySqlData = [
    ...
    "INSERT IGNORE INTO books VALUES (2,'Davinci Code', 485, 33.15);",
    "INSERT IGNORE INTO books (id, name, pages, price) VALUES (3,'Dark Knight', 685, 44.44);",
    "INSERT IGNORE INTO books (id, name, pages, price) VALUES (4,'The Arrival', 1258, 125.88);",
